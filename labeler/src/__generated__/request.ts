...
export type GetBackendImageQuery = { __typename?: "Query" } & {
  image?: Maybe<
    { __typename?: "Image" } & Pick<
      Image,
      "id" | "width" | "height" | "rawUrl" | "mimetype" | "faceScanDate"
    >
  >;
};
...
export type LabelImageMutation = { __typename?: "Mutation" } & {
  labelImage?: Maybe<{ __typename?: "Image" } & Pick<Image, "id">>;
};
...
export function getSdk(
  ...
  return {
    getBackendImage(
      variables: GetBackendImageQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetBackendImageQuery> {
      return withWrapper(() =>
        client.request<GetBackendImageQuery>(
          GetBackendImageDocument,
          variables,
          requestHeaders
        )
      );
    ...
    labelImage(
      variables: LabelImageMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<LabelImageMutation> {
      return withWrapper(() =>
        client.request<LabelImageMutation>(
          LabelImageDocument,
          variables,
          requestHeaders
        )
