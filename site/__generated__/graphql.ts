...
function fetcher<TData, TVariables>(query: string, variables?: TVariables) {
  return async (): Promise<TData> => {
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/api/graphql` as string,
      {
        method: "POST",
...
export type AddToQueueMutation = { __typename?: "Mutation" } & {
  scanFaces: { __typename?: "QueueInfo" } & Pick<QueueInfo, "queueSize">
}
...
export type OneImageQuery = { __typename?: "Query" } & {
  image?: Maybe<
    { __typename?: "Image" } & Pick<Image, "liked" | "faceScanDate"> & {
        unknownFaces: Array<
          { __typename?: "Face" } & {
            appearance?: Maybe<
              { __typename?: "Appearance" } & AppearanceDataFragment
            >
          } & FaceDataFragment
        >
        appearances: Array<
          { __typename?: "Appearance" } & Pick<Appearance, "id"> & {
              ...
              faces: Array<{ __typename?: "Face" } & FaceDataFragment>
            }
        >
        uploadedBy?: Maybe<
          { __typename?: "User" } & {
            roles: Array<{ __typename?: "Role" } & UserRoleDataFragment>
          } & UserDataFragment
        >
      } & ImageDataFragment
  >
...
export type PersonPageQuery = { __typename?: "Query" } & {
  person?: Maybe<
    { __typename?: "Person" } & Pick<Person, "name"> & {
        aliases: Array<{ __typename?: "Alias" } & Pick<Alias, "name">>
        preferredAlias?: Maybe<{ __typename?: "Alias" } & Pick<Alias, "name">>
        appearances: Array<
          { __typename?: "Appearance" } & Pick<Appearance, "createdAt"> & {
              image: { __typename?: "Image" } & {
                thumbnail: { __typename?: "Thumbnail" } & Pick<
                  Thumbnail,
                  "medium"
                >
              } & ImageDataFragment
...
export type AppearanceDataFragment = { __typename?: "Appearance" } & Pick<
  Appearance,
  "id"
> & { person: { __typename?: "Person" } & Pick<Person, "id" | "name"> }
...
export type ConnectionGraphQuery = { __typename?: "Query" } & {
  imageConnections?: Maybe<
    { __typename?: "ImageConnections" } & {
      edges: Array<
        { __typename?: "ImageEdge" } & Pick<ImageEdge, "type" | "to" | "from">
      >
      people: Array<{ __typename?: "Person" } & Pick<Person, "id" | "name">>
      images: Array<
        { __typename?: "Image" } & Pick<Image, "slug" | "id" | "rawUrl">
      >
    }
  >
}

export type FaceDataFragment = { __typename?: "Face" } & Pick<
  Face,
...
export type HomepageQuery = { __typename?: "Query" } & {
  images: Array<{ __typename?: "Image" } & GridImageFragment>
}

export type ImageDataFragment = { __typename?: "Image" } & Pick<
  Image,
  | "id"
  | "height"
  | "width"
...
export type GridImageFragment = { __typename?: "Image" } & Pick<
  Image,
  "id" | "url" | "rawUrl" | "aspectRatio" | "createdAt"
> & {
    thumbnail: { __typename?: "Thumbnail" } & Pick<Thumbnail, "small">
    uploadedBy?: Maybe<{ __typename?: "User" } & Pick<User, "id" | "name">>
    appearances: Array<
      { __typename?: "Appearance" } & Pick<Appearance, "id"> & {
...
export type AppearanceWithFacesFragment = { __typename?: "Appearance" } & Pick<
  Appearance,
  "id"
> & {
    faces: Array<{ __typename?: "Face" } & FaceDataFragment>
...
export type AddAppearanceMutation = { __typename?: "Mutation" } & {
  appearance: { __typename?: "Appearance" } & AppearanceWithFacesFragment
}
...
export type RemoveAppearanceMutation = { __typename?: "Mutation" } & {
  appearance: { __typename?: "Appearance" } & Pick<Appearance, "id">
}
...
export type UnlinkFaceMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
  "unlinkFace"
>
...
export type GetUploadResultQuery = { __typename?: "Query" } & {
  image?: Maybe<
    { __typename?: "Image" } & {
      appearances: Array<
        { __typename?: "Appearance" } & Pick<Appearance, "id"> & {
...
export type ToggleLikeMutation = { __typename?: "Mutation" } & {
  toggleLike: { __typename?: "Image" } & Pick<Image, "liked"> &
    ImageDataFragment
}
...
export type UserRoleDataFragment = { __typename?: "Role" } & Pick<Role, "name">
...
export const AddToQueueDocument = `
  ...
  scanFaces(slug: $slug) {
    ...
    `
export const useAddToQueueMutation = <TError = unknown, TContext = unknown>(
  ...
  useMutation<
    ...
    TContext
  >(
    (variables?: AddToQueueMutationVariables) =>
      fetcher<AddToQueueMutation, AddToQueueMutationVariables>(
        AddToQueueDocument,
        variables
      )(),
    options
...
export const useOneImageQuery = <TData = OneImageQuery, TError = unknown>(
...
export const PersonPageDocument = `
  ...
  person(where: {id: $id}) {
    ...
    ${ImageDataFragmentDoc}`
export const usePersonPageQuery = <TData = PersonPageQuery, TError = unknown>(
  ...
  useQuery<PersonPageQuery, TError, TData>(
    ...
    fetcher<PersonPageQuery, PersonPageQueryVariables>(
      PersonPageDocument,
      variables
    ),
    options
...
>(
  ...
  useQuery<ConnectionGraphQuery, TError, TData>(
    ...
    fetcher<ConnectionGraphQuery, ConnectionGraphQueryVariables>(
      ConnectionGraphDocument,
      variables
    ),
    options
  )
...
export const useAddAppearanceMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    AddAppearanceMutation,
    TError,
    AddAppearanceMutationVariables,
    TContext
  >
) =>
  useMutation<
    ...
    TContext
  >(
    (variables?: AddAppearanceMutationVariables) =>
      fetcher<AddAppearanceMutation, AddAppearanceMutationVariables>(
        AddAppearanceDocument,
        variables
      )(),
    options
  )
...
>(
  options?: UseMutationOptions<
    RemoveAppearanceMutation,
    TError,
    RemoveAppearanceMutationVariables,
    TContext
  >
) =>
  useMutation<
    ...
    TContext
  >(
    (variables?: RemoveAppearanceMutationVariables) =>
      fetcher<RemoveAppearanceMutation, RemoveAppearanceMutationVariables>(
        RemoveAppearanceDocument,
        variables
      )(),
    options
  )
export const LinkFaceDocument = `
  ...
  appearance: linkFace(faceId: $faceId, appearanceId: $appearanceId) {
    ...
    ${AppearanceWithFacesFragmentDoc}`
export const useLinkFaceMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    LinkFaceMutation,
    TError,
    LinkFaceMutationVariables,
    TContext
  >
) =>
  useMutation<LinkFaceMutation, TError, LinkFaceMutationVariables, TContext>(
    (variables?: LinkFaceMutationVariables) =>
      fetcher<LinkFaceMutation, LinkFaceMutationVariables>(
        LinkFaceDocument,
        variables
      )(),
    options
...
export const UnlinkFaceDocument = `
  ...
  unlinkFace(faceId: $faceId, appearanceId: $appearanceId)
    ...
    `
export const useUnlinkFaceMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    UnlinkFaceMutation,
    TError,
    UnlinkFaceMutationVariables,
    TContext
  >
) =>
  useMutation<
    ...
    TContext
  >(
    (variables?: UnlinkFaceMutationVariables) =>
      fetcher<UnlinkFaceMutation, UnlinkFaceMutationVariables>(
        UnlinkFaceDocument,
        variables
      )(),
    options
...
>(
  ...
  useQuery<GetUploadResultQuery, TError, TData>(
    ...
    fetcher<GetUploadResultQuery, GetUploadResultQueryVariables>(
      GetUploadResultDocument,
      variables
    ),
    options
  )
...
export const ToggleLikeDocument = `
  ...
  toggleLike(imageId: $id) {
    ...
    ${ImageDataFragmentDoc}`
export const useToggleLikeMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    ToggleLikeMutation,
    TError,
