...
export type OneImageQuery = { __typename?: "Query" } & {
  image?: Maybe<
    { __typename?: "Image" } & Pick<Image, "liked" | "faceScanDate"> & {
        ...
        >;
        uploadedBy?: Maybe<{ __typename?: "User" } & UserDataFragment>;
      } & ImageDataFragment
  >;
};
...
export type SearchPersonQuery = { __typename?: "Query" } & {
  searchPerson: Array<{ __typename?: "Person" } & Pick<Person, "id" | "name">>;
};
...
>(
  ...
  useQuery<SearchPersonQuery, TError, TData>(
    ...
    fetcher<SearchPersonQuery, SearchPersonQueryVariables>(
