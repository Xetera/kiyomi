...
export const UpsertGroupDocument = gql`
    mutation upsertGroup($where: GroupWhereUniqueInput!, $create: GroupCreateInput!, $update: GroupUpdateInput!) {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    connectionGraph(variables: ConnectionGraphQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<ConnectionGraphQuery> {
      return withWrapper(() => client.request<ConnectionGraphQuery>(ConnectionGraphDocument, variables, requestHeaders));
    },
    ...
    upsertGroup(variables: UpsertGroupMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<UpsertGroupMutation> {
      return withWrapper(() => client.request<UpsertGroupMutation>(UpsertGroupDocument, variables, requestHeaders));
    },
