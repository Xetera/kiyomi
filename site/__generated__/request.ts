...
export type UpsertPersonMutation = { __typename?: "Mutation" } & {
  upsertOnePerson: { __typename?: "Person" } & Pick<Person, "id">
}
...
export type UpsertGroupMutation = { __typename?: "Mutation" } & {
  upsertOneGroup: { __typename?: "Group" } & Pick<Group, "id">
}

export type AllPersonsQueryVariables = Exact<{ [key: string]: never }>

export type AllPersonsQuery = { __typename?: "Query" } & {
  people: Array<
...
`
export const ConnectionGraphDocument = gql`
...
export function getSdk(
  ...
  return {
    ...
    ): Promise<ConnectionGraphQuery> {
      return withWrapper(() =>
        client.request<ConnectionGraphQuery>(
    ...
    AddAppearance(
      ...
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<AddAppearanceMutation> {
      return withWrapper(() =>
        client.request<AddAppearanceMutation>(
    ...
    RemoveAppearance(
      ...
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<RemoveAppearanceMutation> {
      return withWrapper(() =>
        client.request<RemoveAppearanceMutation>(
    ...
    LinkFace(
      ...
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<LinkFaceMutation> {
      return withWrapper(() =>
        client.request<LinkFaceMutation>(
          LinkFaceDocument,
          variables,
          requestHeaders
        )
    ...
    UnlinkFace(
      ...
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<UnlinkFaceMutation> {
      return withWrapper(() =>
        client.request<UnlinkFaceMutation>(
          UnlinkFaceDocument,
          variables,
          requestHeaders
        )
    ...
    getUploadResult(
      ...
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetUploadResultQuery> {
      return withWrapper(() =>
        client.request<GetUploadResultQuery>(
    ...
    Me(
      ...
      return withWrapper(() =>
        client.request<MeQuery>(MeDocument, variables, requestHeaders)
      )
    },
    toggleLike(
    ...
    upsertPerson(
      variables: UpsertPersonMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<UpsertPersonMutation> {
      return withWrapper(() =>
        client.request<UpsertPersonMutation>(
    ...
    upsertGroup(
      variables: UpsertGroupMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<UpsertGroupMutation> {
      return withWrapper(() =>
        client.request<UpsertGroupMutation>(
          UpsertGroupDocument,
          variables,
          requestHeaders
        )
    ...
    allPersons(
      ...
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<AllPersonsQuery> {
      return withWrapper(() =>
        client.request<AllPersonsQuery>(
          AllPersonsDocument,
          variables,
          requestHeaders
        )
