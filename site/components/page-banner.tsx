import { Flex, FlexProps, Image, Link, Text, VStack } from "@chakra-ui/react"
import { ReactElement, ReactNode } from "react"
import { TabGenerator } from "@/components/linked-tabs"
import Hr from "@/components/hr"

export const PageBannerTopic = ({ children }) => (
  <Text
    as="h2"
...
export const PageBannerTitle = ({ children }) => (
  <Text
    as="h1"
...
export const PageBannerSubtitle = ({ children }) => (
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Hr w="full" borderColor="rgba(0, 0, 0, 0.1)" />
